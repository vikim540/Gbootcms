...
type Member struct {
	...
	LoginCount    int       `gorm:"column:logincount" json:"logincount"`
	...
	RegisterTime  time.Time `gorm:"column:registertime" json:"registertime"`
...
type Comment struct {
	ID         uint      `gorm:"primaryKey" json:"id"`
	UserID     int       `gorm:"column:ouserid" json:"user_id"`
	...
	Pcode      int       `gorm:"column:pcode" json:"pcode"`
	IFirst     int       `gorm:"column:ifirst" json:"ifirst"`
