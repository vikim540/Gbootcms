...
func (lb *LabelController) Index(c *gin.Context) {
	...
	if c.Request.Method == "POST" {
		...
		lb.JSONOKMsg(c, "Updated "+strconv.Itoa(updated)+" labels")
		return
	}
...
func (lb *LabelController) Add(c *gin.Context) {
	if c.Request.Method == "POST" {
		...
		lb.JSONOKMsg(c, "Added successfully")
		return
	}
...
func (lb *LabelController) Mod(c *gin.Context) {
	...
	if c.Request.Method == "POST" {
		...
		lb.JSONOKMsg(c, "Modified successfully")
		return
	}
...
func (lb *LabelController) Del(c *gin.Context) {
	...
	lb.JSONOKMsg(c, "Deleted successfully")
}
